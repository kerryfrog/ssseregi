...
const AppPrivacy = () => (
  <Main
    meta={
      <Meta
        title="Privacy Policy for 놀러와 펫"
        description="Privacy policy for the 놀러와 펫 app."
      />
    }
  >
    <Content>
      ...
      <p>
        This privacy policy applies to the 놀러와 펫 app (hereby referred to as
        &quot;Application&quot;) for mobile devices that was created by 63frog
      ...
      <h3 className="mt-4">Third Party Access</h3>
      <p>
      ...
      <h3 className="mt-4">Opt-Out Rights</h3>
      <p>
      ...
      <h3 className="mt-4">Data Retention Policy</h3>
      <p>
        ...
        Application, please contact them at turtledev00@gmail.com and they will
      ...
      <p>
        ...
        (turtledev00@gmail.com) so that they will be able to take the necessary
        actions.
      </p>
      ...
      <p>This privacy policy is effective as of 2026-01-18</p>
      ...
      <p>
        ...
        Provider via email at turtledev00@gmail.com.
      </p>
    </Content>
  </Main>
);
